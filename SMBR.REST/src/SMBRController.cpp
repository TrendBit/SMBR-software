...
std::shared_ptr<oatpp::web::protocol::http::outgoing::Response> SMBRController::getCoreLoad(const std::shared_ptr<IncomingRequest>& request, const oatpp::Enum<dto::ModuleEnum>::AsString& module) {
    return process(__FUNCTION__, [&](){
        std::shared_ptr<ICommonModule> mod;
        if (module == dto::ModuleEnum::pump) {
            auto instanceStr = request->getQueryParameter("instance");
...
std::shared_ptr<oatpp::web::protocol::http::outgoing::Response> SMBRController::getCoreTemp(const std::shared_ptr<IncomingRequest>& request, const oatpp::Enum<dto::ModuleEnum>::AsString& module) {
    return process(__FUNCTION__, [&](){
        std::shared_ptr<ICommonModule> mod;
        if (module == dto::ModuleEnum::pump) {
            auto instanceStr = request->getQueryParameter("instance");
...
std::shared_ptr<oatpp::web::protocol::http::outgoing::Response> SMBRController::getBoardTemp(const std::shared_ptr<IncomingRequest>& request, const oatpp::Enum<dto::ModuleEnum>::AsString& module) {
    return process(__FUNCTION__, [&](){
        std::shared_ptr<ICommonModule> mod;
        if (module == dto::ModuleEnum::pump) {
            auto instanceStr = request->getQueryParameter("instance");
...
std::shared_ptr<oatpp::web::protocol::http::outgoing::Response> SMBRController::getFwVersion(const std::shared_ptr<IncomingRequest>& request, const oatpp::Enum<dto::ModuleEnum>::AsString& module) {
    return process(__FUNCTION__, [&]() {
        std::shared_ptr<ICommonModule> mod;
        if (module == dto::ModuleEnum::pump) {
            auto instanceStr = request->getQueryParameter("instance");
...
std::shared_ptr<oatpp::web::protocol::http::outgoing::Response> SMBRController::getHwVersion(const std::shared_ptr<IncomingRequest>& request, const oatpp::Enum<dto::ModuleEnum>::AsString& module) {
    return process(__FUNCTION__, [&]() {
        std::shared_ptr<ICommonModule> mod;
        if (module == dto::ModuleEnum::pump) {
            auto instanceStr = request->getQueryParameter("instance");
...
std::shared_ptr<oatpp::web::protocol::http::outgoing::Response> SMBRController::calibrateAerator(const oatpp::Object<FlowrateDto>& body) {
...
uint8_t SMBRController::pumpCountForInstance(Instance instance) {
    return waitFor(systemModule->pumpsModule(instance)->getPumpCount());
}

void SMBRController::validatePumpIndex(Instance instance, uint8_t pump_index) {
...
std::shared_ptr<oatpp::web::protocol::http::outgoing::Response> SMBRController::getPumpInfo(const UInt8& instance_index, const UInt8& pump_index) {
    return process(__FUNCTION__, [&](){
        if (instance_index < 1 || instance_index > 12) {
            throw ArgumentException("Invalid instance_index. Must be between 1 and 12.");
        }
...
std::shared_ptr<oatpp::web::protocol::http::outgoing::Response> SMBRController::getPumpSpeed(const UInt8& instance_index, const UInt8& pump_index) {
    return process(__FUNCTION__, [&](){
        if (instance_index < 1 || instance_index > 12) {
            throw ArgumentException("Invalid instance_index. Must be between 1 and 12.");
        }
...
std::shared_ptr<oatpp::web::protocol::http::outgoing::Response> SMBRController::setPumpFlowrate(const UInt8& instance_index, const UInt8& pump_index, const oatpp::Object<FlowrateDto>& body) {
    return processBool(__FUNCTION__, [&](){
        if (instance_index < 1 || instance_index > 12) {
            throw ArgumentException("Invalid instance_index. Must be between 1 and 12.");
        }
...
std::shared_ptr<oatpp::web::protocol::http::outgoing::Response> SMBRController::calibratePump(const UInt8& instance_index, const UInt8& pump_index, const oatpp::Object<FlowrateDto>& body) {
    return processBool(__FUNCTION__, [&](){
        if (instance_index < 1 || instance_index > 12) {
            throw ArgumentException("Invalid instance_index. Must be between 1 and 12.");
        }
